                ...
                <div class="p-6 text-gray-900">
                    <div class="container mx-auto p-4 w-1/2">
                        <div class="bg-white rounded-lg shadow-lg p-6">
                            ...
                            <h1 class="text-2xl font-semibold my-4">Add New Criteria</h1>
                            <form action="{{ route('kriteria.store') }}" method="POST">
                                @csrf
                                <div class="mb-4">
                                    <label for="name" class="block text-gray-700">Name</label>
                                    <input type="text" name="name" id="name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600" placeholder="Masukkan kriteria">
                                    @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" name="value" id="value" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-600" value="{{ old('value') }}" step="0.01" min="0" max="100" placeholder="Masukkan bobot, contoh: 0.20">
                                    @error('value')
                                    <div class="text-red-500 mt-2 text-sm">{{ $message }}</div>
                                    @enderror
                                </div>
